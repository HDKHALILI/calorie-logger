export default {
  ...
  data_points: [
      ...
      intake_list: [
        {
          ...
          serving_unit: "link",
          current_meal_weight: 150,
          current_meal_calories: 516,
        ...
        },
        {
          ...
          serving_unit: "cup",
          current_meal_weight: 610,
          current_meal_calories: 583.91,
        ...
        },
        {
          ...
          serving_qty: 1,
          serving_unit: "breast",
          current_meal_weight: 240,
          current_meal_calories: 396,
        ...
        },
        {
          ...
          serving_qty: 1,
          serving_unit: "slice",
          current_meal_weight: 56,
          current_meal_calories: 226.24,
        ...
        },
        {
          ...
          current_meal_weight: 280,
          current_meal_calories: 137.2,
    ...
    {
      date: new Date("August 29 2019"),
      intake_list: [
        {
          food_name: "fried eggs",
          serving_qty: 1,
          serving_unit: "large",
          current_meal_weight: 92,
          current_meal_calories: 180,
        ...
        },
        {
          ...
          serving_qty: 0.5,
          serving_unit: "cup",
          current_meal_weight: 224,
          current_meal_calories: 507.98,
        ...
        },
        {
          ...
          food_name: "Boneless Skinless Chicken Breasts",
          serving_unit: "oz",
          current_meal_weight: 112,
          current_meal_calories: 110,
